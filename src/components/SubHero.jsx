...
function SubHero() {
  const unify = useRef(null);
  function scrollIntoUnify(){
    unify.current.scrollIntoView({behavior: 'smooth',block:'center'})
  }
  return (
    <div className='flex flex-col text-center mt-20 items-center'>
        ...
        <Card  src ='../../public/Unify.png' text='Unify feedback with your business context to prioritize what truly matters' alt='Unify' onClick={scrollIntoUnify}/>
        ...
        <Description  ref={unify} Badgetext='Unify' Heading='Unify feedback with your business context to prioritize what truly matters' 

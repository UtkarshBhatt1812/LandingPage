...
"
      ...
      <p className="text-xs font-light ml-30 w-165 leading-6">
        Enterpret is the leading customer intelligence platform that unifies all
        your feedback with AI that understands your business, turning noise into
      ...
      <div className="flex items-center ml-30 mt-10 gap-15 text-[13px] font-extralight tracking-tight ">
        <button className="flex gapx-2 py-1 items-center text-white bg-[#393F4E] px-2 py-1.5 rounded-sm">
          Book a demo
          <svg
            width="14"
            height="14"
        ...
        <div
          className="flex gapx-2 py-1 items-center text-black px-2 py-1.5 rounded-sm bg-[rgb(220,227,211)] z-1"
          onMouseEnter={() => {
            setHover(true);
          }}
          onMouseLeave={() => {
      ...
      <div className="flex justify-center p-15 ">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/brTWaZCvTq4?si=QoOQGQKiMPDGdwga"
      ...
      <p className="ml-30 mb-2 font-extralight text-xs text-neutral-400 flex items-center p-2">
        {" "}
        The Fastest-Growing Companies Use Enterpret
      </p>
      <CustomerGrid />
    </div>
  );
